...
APIS = {
    ...
    "github": "https://api.github.com/repos/astral-sh/uv",
    "worldbank": "https://api.worldbank.org/v2/country/WLD/indicator/SP.POP.TOTL?format=json&date=2022",
    "openmeteo": "https://api.open-meteo.com/v1/forecast?latitude=25.032969&longitude=121.565418&current=temperature_2m,wind_speed_10m&timezone=Asia%2FTaipei",
    "restcountries": "https://restcountries.com/v3.1/name/japan",
    "pokeapi": "https://pokeapi.co/api/v2/pokemon/pikachu",
    "dogcat": "https://api.thedogapi.com/v1/images/search",
